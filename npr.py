...
def scrape(prg, urldate, year, month, day, wdate, fdstr=None):
    pgid = PROGRAMS[prg]
    ...
    if fdstr is None:
        ...
        m3u_file = open(os.path.join(LPATH, f"{prg}-{fdstr}.m3u"), 'w')
    ...
    with open(output_file, 'r') as f:
        ...
        for story in tblob:
            ...
            playlist.append(data["audioUrl"].split("?")[0])
...
def main():
    ...
    scrape(prg, urldate, year, month, day, wdate, fdstr)
    grab(prg, date_str, year)
